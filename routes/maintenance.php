...
$router->get('/mantenimiento/edit/{id}', 'Maintenance\MantenimientoController@edit');
$router->post('/mantenimiento/update/{id}', 'Maintenance\MantenimientoController@update');
...
$router->get('/mantenimiento/paros/edit/{id}', 'Maintenance\MantenimientoController@paroEdit');
$router->post('/mantenimiento/paros/update/{id}', 'Maintenance\MantenimientoController@paroUpdate');
