<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="d-flex gap-2">
        <a href="<?= url('notificaciones-cliente') ?>" class="btn btn-sm btn-outline-warning position-relative">
...
<div class="row mb-4">
    ...
    <div class="col-md-3 mb-3">
        ...
        <div class="stat-card card-<?= $tickets_abiertos > 0 ? 'warning' : 'info' ?>">
            <div class="stat-content">
                <div class="stat-number"><?= $tickets_abiertos ?></div>
                <div class="stat-label"><i class="bi bi-headset"></i> Tickets Abiertos</div>
            </div>
    ...
    <div class="col-md-3 mb-3">
        ...
        <div class="stat-card card-danger">
            <div class="stat-content">
                ...
                <div class="stat-label"><i class="bi bi-heart"></i> Favoritos</div>
            </div>
...
<div class="row mb-4">
    <div class="col-md-6 mb-3">
        <div class="card shadow-sm h-100">
            <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                <span><i class="bi bi-bell"></i> Notificaciones Recientes</span>
                <a href="<?= url('notificaciones-cliente') ?>" class="btn btn-sm btn-light">Ver todas</a>
            </div>
            <div class="card-body p-0">
                <?php if (empty($notificaciones)): ?>
                <div class="text-center py-4">
                    <i class="bi bi-bell-slash text-muted" style="font-size: 2rem;"></i>
                    <p class="mt-2 text-muted small">Sin notificaciones recientes</p>
                </div>
                <?php else: ?>
                <div class="list-group list-group-flush">
                    <?php foreach ($notificaciones as $n): ?>
                    <div class="list-group-item list-group-item-action d-flex gap-2 py-2 <?= !$n['leida'] ? 'fw-semibold' : '' ?>">
                        ...
                        <div class="flex-grow-1">
                            <small class="d-block"><?= safe_string($n['titulo']) ?></small>
    ...
    <div class="col-md-6 mb-3">
        <div class="card shadow-sm h-100">
            <div class="card-header bg-dark text-white"><i class="bi bi-building"></i> Mi Empresa</div>
            <div class="card-body">
                <p class="mb-1"><strong>Razón Social:</strong> <?= safe_string($cliente['razon_social'] ?? 'N/A') ?></p>
                <p class="mb-1"><strong>RFC:</strong> <?= safe_string($cliente['rfc'] ?? 'N/A') ?></p>
                <p class="mb-1"><strong>Contacto:</strong> <?= safe_string($cliente['contacto_nombre'] ?? 'N/A') ?></p>
                <?php if ($vendedor_asignado): ?>
                <p class="mb-0"><strong>Vendedor:</strong> <?= safe_string($vendedor_asignado['nombre'] . ' ' . $vendedor_asignado['apellido_paterno']) ?></p>
                <?php endif; ?>
                <div class="mt-2">
...
<div class="card shadow-sm mb-4">
    <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
        ...
        <a href="<?= url('mis-pedidos') ?>" class="btn btn-sm btn-light">Ver todos</a>
    </div>
    <div class="card-body p-0">
...
<!-- Sección: Compras recientes -->
<div class="card shadow-sm mb-4" id="mis-compras">
    <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
        <span><i class="bi bi-clock-history"></i> Últimas Compras</span>
