                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="<?= url('moldes/delete/' . $m['id_molde']) ?>" style="display:inline">
                                <input type="hidden" name="csrf_token" value="<?= csrf_token() ?>">
                                <button type="submit" class="btn btn-sm btn-outline-danger" onclick="return confirm('¿Eliminar molde?')"><i class="bi bi-trash"></i></button>
                            </form>
                        </td>
                    </tr>
                    <?php endforeach; ?>
