...
class CarteraController extends Controller
{
    private function obtenerCliente(): array
    {
        ...
        $cliente = $db->fetchOne("SELECT * FROM clientes WHERE id_cliente = :id", ['id' => $idCliente]);
        return [$db, $idCliente, $cliente];
    }
    ...
    public function index(): void
    {
        ...
        [$db, $idCliente, $cliente] = $this->obtenerCliente();
        ...
        $tiposTarjeta = $db->fetchAll("SELECT DISTINCT tipo FROM tarjetas_cliente WHERE activa = 1 ORDER BY tipo");
    ...
    public function agregarTarjeta(): void
    {
        ...
        [$db, $idCliente] = $this->obtenerCliente();
    ...
    public function eliminarTarjeta(array $params): void
    {
        ...
        $db->update('tarjetas_cliente', ['activa' => 0], 'id_tarjeta = :id', ['id' => $idTarjeta]);
    ...
    public function generarReferencia(): void
    {
        ...
        $db->insert('depositos_referencia', [
            'id_cliente' => $idCliente,
