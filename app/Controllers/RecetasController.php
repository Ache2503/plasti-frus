...
class RecetasController extends Controller
{
    ...
    public function index(): void
    {
        $this->checkAccess();
        $data = [
            'recetas' => $this->receta->getWithRelations(),
    ...
    public function store(): void
    {
        ...
        $idReceta = $this->receta->create($data);
    ...
    {
        $this->checkAccess();
        $receta = $this->receta->getByIdWithRelations($params['id']);
        if (!$receta) {
        ...
        $data = [
            'receta' => $receta,
            'detalles' => $this->receta->getDetallesByReceta($params['id']),
            'productos' => $productoModel->all(),
            'maquinas' => $maquinaModel->all(),
    ...
    public function update(array $params): void
    {
        ...
        $this->receta->update($params['id'], $data);
