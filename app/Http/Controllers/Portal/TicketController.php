...
class TicketController extends Controller
{
    ...
    public function index(): void
    {
        ...
        $tickets = $idCliente ? $this->ticketModel->getByCliente($idCliente) : [];
    ...
    public function store(): void
    {
        ...
        $idCliente = user_id_cliente();
        $titulo = trim($this->postParam('titulo', ''));
        $descripcion = trim($this->postParam('descripcion', ''));
    ...
    public function show(array $params): void
    {
        ...
        $ticket = $this->ticketModel->getWithRespuestas($idTicket, $idCliente);
    ...
    public function responder(array $params): void
    {
        ...
        $result = $this->ticketModel->addRespuesta($idTicket, $idCliente, $mensaje, $archivo);
    ...
    public function cerrar(array $params): void
    {
        ...
        if ($this->ticketModel->cerrar($idTicket, $idCliente)) {
