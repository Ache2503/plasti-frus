...
class BalanceController extends Controller
{
    ...
    public function balanza(): void
    {
        ...
        $data = [
            ...
            'cuentas' => $this->getBalanzaData($fechaFin),
            'fecha' => $fechaFin,
        ];
    ...
    public function estadoResultados(): void
    {
        ...
        $ingresos = $this->getEstadoResultadosData($anio);

        $total_ingresos = 0;
        $total_gastos = 0;
        foreach ($ingresos as $cta) {
    ...
    public function balanceGeneral(): void
    {
        ...
        $data = [
            ...
            'rol' => user_rol(),
            'rol_nombre' => user_rol_nombre(),
            'cuentas' => $this->getBalanceGeneralData($fecha),
            'fecha' => $fecha,
        ];
    ...
    public function libroDiario(): void
    {
        ...
        $movimientos = $this->getLibroDiarioData($fecha_desde, $fecha_hasta);
    ...
    public function libroMayor(array $params): void
    {
        ...
        $cuenta = $this->getCuentaById($idCuenta);
        if (!$cuenta) {
        ...
        $movimientos = $this->getMovimientosMayor($idCuenta, $fecha_desde, $fecha_hasta);
    ...
    private function getEstadoResultadosData(string $anio): array
    {
        return $this->db->fetchAll(
    ...
    private function getBalanceGeneralData(string $fecha): array
    {
        return $this->db->fetchAll(
    ...
    private function getCuentaById(int $id): ?array
    {
    ...
    private function getMovimientosMayor(int $idCuenta, string $desde, string $hasta): array
    {
        return $this->db->fetchAll(
