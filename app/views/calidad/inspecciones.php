            ...
            <table class="table datatable table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="<?= url('calidad/inspecciones/delete/' . $i['id_inspeccion']) ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('¿Eliminar?')"><i class="bi bi-trash"></i></a></td>
                    </tr>
                    <?php endforeach; ?>
