    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <?php endif; ?>
                <a href="<?= url('incidencias/delete/' . $inc['id_incidencia']) ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('¿Eliminar incidencia?')"><i class="bi bi-trash"></i></a>
            </td>
        </tr>
        <?php endforeach; ?>
