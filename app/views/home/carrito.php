<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <a href="<?= url() ?>" class="btn btn-sm btn-outline-secondary"><i class="bi bi-arrow-left"></i> Seguir comprando</a>
</div>
...
<div class="text-center py-5">
    ...
    <a href="<?= url() ?>" class="btn btn-dark"><i class="bi bi-shop"></i> Ver tienda</a>
</div>
<?php else: ?>
